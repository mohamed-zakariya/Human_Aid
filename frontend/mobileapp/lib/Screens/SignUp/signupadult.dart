...
class _SignupadultState extends State<Signupadult> {
  ...
  bool _autoValidate = false; // Add auto-validation flag

  // Track if all fields are filled - Updated validation logic
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildEnhancedInputField(
                      ...
                      label: S.of(context).signuptitleusername,
                      hint: S.of(context).signupinputfieldusername,
                    ...
                    _buildEnhancedInputField(
                      ...
                      label: S.of(context).signuptitleemail,
                      hint: S.of(context).signupinputfieldemail,
            ...
            Padding(
              ...
              child: AnimatedContainer(
                ...
                child: Material(
                  ...
                  child: InkWell(
                    borderRadius: BorderRadius.circular(15),
                    onTap: !_isLoading ? signup : null, // Allow signup even if form appears invalid
                    child: Center(
                      child: _isLoading
                          ? const SizedBox(
                        height: 25,
