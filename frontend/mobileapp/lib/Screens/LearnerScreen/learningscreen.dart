      ...
      appBar: AppBar(
        ...
        actions: const [
          Padding(
            ...
            child: CircleAvatar(
              backgroundImage: AssetImage("assets/images/boy.jpeg"), // Replace with actual image
            ),
          ),
        ],
      ),
                ...
                children: [
                  ...
                  const Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Mathematics Lessons", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
