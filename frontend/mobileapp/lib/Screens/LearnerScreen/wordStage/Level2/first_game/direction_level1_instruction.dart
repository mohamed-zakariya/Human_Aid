...
class _DirectionInstructionsPageState extends State<DirectionInstructionsPage> {
  ...
  Future<void> speakInstructions() async {
    await flutterTts.speak(S.of(context).ttsInstructions);
  }
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              Flexible(child: Text(S.of(context).instructionTimer)),
                            ],
                          ),
                          const SizedBox(height: 8),
                          Row(
                            children: [
                              const Icon(Icons.hearing, color: Color(0xFF7367F0)),
                              const SizedBox(width: 8),
                              Flexible(child: Text(S.of(context).instructionLookCarefully)),
                            ],
                          ),
                          const SizedBox(height: 8),
                          Row(
                            children: [
                              ...
                              const SizedBox(width: 8),
                              Flexible(child: Text(S.of(context).instructionAnswerShown)),
                            ],
                          ),
                        ],
                      ),
