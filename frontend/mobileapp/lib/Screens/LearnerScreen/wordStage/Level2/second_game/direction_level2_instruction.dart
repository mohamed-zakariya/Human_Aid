                          ...
                          children: const [
                            Row(
                              children: [
                                ...
                                SizedBox(width: 8),
                                Flexible(child: Text("سيكون لكل سؤال مؤقت 8 ثوانٍ للإجابة.")),
                              ],
                            ),
                            SizedBox(height: 8),
                            Row(
                              children: [
                                Icon(Icons.touch_app, color: Color(0xFF7367F0)),
                                SizedBox(width: 8),
                                Flexible(child: Text("اسحب الصورة وضعها في الاتجاه الصحيح.")),
                              ],
                            ),
                            SizedBox(height: 8),
                            Row(
                              children: [
                                ...
                                SizedBox(width: 8),
                                Flexible(child: Text("بعد كل سؤال، سيتم عرض الاتجاه الصحيح.")),
                              ],
                            ),
                          ],
                        ),
