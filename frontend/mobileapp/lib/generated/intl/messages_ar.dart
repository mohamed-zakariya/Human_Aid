...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(object) => "أحضر ${object}";

  static String m2(answer) => "الإجابة الصحيحة: ${answer}";

  static String m3(direction) => "الاتجاه الصحيح هو ${direction}";

  static String m4(name) => "لوحة تحكم ${name}";

  static String m5(item, direction) => "اسحب ${item} إلى اتجاه ${direction}";

  static String m6(letter) => "ارسم الحرف \"${letter}\"";

  static String m7(percent) => "%${percent}";

  static String m8(score, total) => "النتيجة النهائية: ${score} من ${total}";

  static String m9(score, total) => "🎉 أحسنت! درجتك: ${score} من ${total}";

  static String m10(name) => "مرحباً ${name}";

  static String m11(count) => "أكمل متعلموك ${count} نشاطًا اليوم";

  static String m12(level) => "🎉 رائع! لقد أكملت المستوى ${level}!";

  static String m13(remaining) => "اسمع مرة أخرى (${remaining} محاولات متبقية)";

  static String m14(count) => "رتب ${count} شهور السنة";

  static String m15(level, count, direction) =>
      "المستوى ${level}: رتب ${count} أشهر ${direction}";

  static String m16(item, direction) => "ضع ${item} في اتجاه ${direction}";

  static String m17(count) => "عدد النقاط: ${count}";

  static String m18(percent) => "${percent}% تم الإنجاز";

  static String m19(points) => "${points} نقطة";

  static String m20(current, total) => "السؤال ${current} / ${total}";

  static String m21(error) => "خطأ: ${error}";

  static String m22(error) => "خطأ في بدء التسجيل: ${error}";

  static String m23(current, total) => "الجولة ${current} من ${total}";

  static String m24(score) => "النتيجة: ${score}";

  static String m25(count) => "${count} ثانية";

  static String m26(seconds) => "${seconds} ثواني متبقية";

  static String m27(direction) => "الاتجاه في ${direction}";

  static String m28(current, total) => "القصة ${current} من ${total}";

  static String m29(count) => "عدد الخطوط: ${count}";

  static String m30(letter) => "📝 تتبع هذا الحرف: ${letter}";

  static String m31(score, total) => "😊 لا بأس! درجتك: ${score} من ${total}";

  static String m32(letter) => "❌ خطأ! الحرف الصحيح هو: ${letter}";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    "accuracy": MessageLookupByLibrary.simpleMessage("الدقة"),
    "add": MessageLookupByLibrary.simpleMessage("إضافة"),
    "addNewLearner": MessageLookupByLibrary.simpleMessage("إضافة متعلم جديد"),
    "add_vocabulary": MessageLookupByLibrary.simpleMessage(
      "إضافة مفردات جديدة",
    ),
    "add_word": MessageLookupByLibrary.simpleMessage("إضافة كلمة"),
    "adultSignupTitle": MessageLookupByLibrary.simpleMessage(
      "إِنْشَاءُ حِسَابٍ كمتعلم",
    ),
    ...
    "attemptsLeft": m0,
    "availableExercises": MessageLookupByLibrary.simpleMessage(
      "التمارين المتاحة",
    ),
    ...
    "bottomNavProfile": MessageLookupByLibrary.simpleMessage("الملف الشخصي"),
    ...
    "changepasswordHint": MessageLookupByLibrary.simpleMessage("كلمة المرور"),
    "checkSummary": MessageLookupByLibrary.simpleMessage("فحص الملخص"),
    "checking": MessageLookupByLibrary.simpleMessage("جاري الفحص..."),
    "chooseLanguageSubtitle": MessageLookupByLibrary.simpleMessage(
      "حدد لغتك المفضلة",
    ),
    "chooseLanguageTitle": MessageLookupByLibrary.simpleMessage("اختر اللغة"),
    ...
    "continueLearning": MessageLookupByLibrary.simpleMessage("واصل التعلُّم"),
    ...
    "createAccountGaurdian": MessageLookupByLibrary.simpleMessage(
      "إنشاء حساب ولي أمر",
    ),
    "createAccountUser": MessageLookupByLibrary.simpleMessage(
      "إنشاء حساب مستخدم",
    ),
    "createaccountbutton": MessageLookupByLibrary.simpleMessage("إنشاء الحساب"),
    "cup": MessageLookupByLibrary.simpleMessage("كوب"),
    "dashboardTitle": m4,
    "dashboard_title": MessageLookupByLibrary.simpleMessage("لوحة معلومات "),
    "defaultUserName": MessageLookupByLibrary.simpleMessage("مستخدم"),
    "defaultUsername": MessageLookupByLibrary.simpleMessage("اسم المستخدم"),
    ...
    "directionExerciseTitle": MessageLookupByLibrary.simpleMessage(
      "تمرين الاتجاهات",
    ),
    ...
    "dontGiveUpLearning": MessageLookupByLibrary.simpleMessage(
      "لا تستسلم، التعلم يحتاج وقت",
    ),
    "dontWorry": MessageLookupByLibrary.simpleMessage("لا تخف لا داعي للقلق"),
    "dontWorryTryAgain": MessageLookupByLibrary.simpleMessage(
    ...
    "emailHint2": MessageLookupByLibrary.simpleMessage("******aid@gmail.com"),
    ...
    "errorLoadingLevels": MessageLookupByLibrary.simpleMessage(
    ...
    "exercise2Title": MessageLookupByLibrary.simpleMessage("التدريب التاني"),
    "exerciseCompleted": MessageLookupByLibrary.simpleMessage(
      "تم إنجاز التمرين",
    ),
    "exerciseFinished": MessageLookupByLibrary.simpleMessage("انتهى التمرين"),
    "exerciseInfoTitle": MessageLookupByLibrary.simpleMessage(
      "معلومات عن التمرين",
    ),
    "exerciseProgressLabel": MessageLookupByLibrary.simpleMessage("التقدم"),
    "exerciseProgressPercent": m7,
    "exercise_breakdown": MessageLookupByLibrary.simpleMessage(
      "تفصيل التمارين",
    ),
    ...
    "explore_message": MessageLookupByLibrary.simpleMessage(
      "لنستكشف بعض الأفكار اليوم",
    ),
    "feedbackWidgetAnalyzing": MessageLookupByLibrary.simpleMessage(
      "جاري التحليل...",
    ),
    ...
    "fishGameTitle": MessageLookupByLibrary.simpleMessage(
      "لعبة الأسماك بالحروف",
    ),
    ...
    "gameOverTitle": MessageLookupByLibrary.simpleMessage("🎮 انتهت اللعبة"),
    ...
    "genderValidationError": MessageLookupByLibrary.simpleMessage(
      "اختار النوع",
    ),
    ...
    "great_progress": MessageLookupByLibrary.simpleMessage("تقدم رائع!"),
    "greeting": m10,
    ...
    "helpful_tips": MessageLookupByLibrary.simpleMessage("نصائح مفيدة للتعلم"),
    ...
    "ignoredRecording": MessageLookupByLibrary.simpleMessage(
      "تم تجاهل التسجيل",
    ),
    ...
    "instructionsTitle": MessageLookupByLibrary.simpleMessage("كيفية اللعب"),
    ...
    "keepProgressing": MessageLookupByLibrary.simpleMessage("استمر في التقدم"),
    "keepTryingProgressing": MessageLookupByLibrary.simpleMessage(
      "استمر في المحاولة، أنت تتقدم",
    ),
    "label_games": MessageLookupByLibrary.simpleMessage("الألعاب"),
    ...
    "learnerNavBarProfile": MessageLookupByLibrary.simpleMessage(
      "الملف الشخصي",
    ),
    "learner_details": MessageLookupByLibrary.simpleMessage("تفاصيل المتعلم"),
    "learner_members": MessageLookupByLibrary.simpleMessage("أعضاء المتعلمين"),
    "learner_progress": MessageLookupByLibrary.simpleMessage(
      "تقدّم المتعلّمين",
    ),
    "learners_completed_activities": m11,
    "learningNeedsPatience": MessageLookupByLibrary.simpleMessage(
      "التعلم يحتاج إلى صبر",
    ),
    ...
    "listenAgain": m13,
    "listenToLetter": MessageLookupByLibrary.simpleMessage("استمع إلى الحرف"),
    ...
    "manage_learners": MessageLookupByLibrary.simpleMessage("إدارة المتعلمين"),
    "monitor_daily_activities": MessageLookupByLibrary.simpleMessage(
      "راقب الأنشطة التعليمية اليومية",
    ),
    ...
    "monthsOrderHelpListen": MessageLookupByLibrary.simpleMessage(
      "اضغط على الشهر لسماع اسمه",
    ),
    "monthsOrderHelpOrder": MessageLookupByLibrary.simpleMessage(
      "رتب الشهور من يناير إلى آخر شهر في المستوى",
    ),
    "monthsOrderHelpTranslate": MessageLookupByLibrary.simpleMessage(
      "اضغط على زر الترجمة لتبديل بين الأسماء العربية والشامية",
    ),
    ...
    "monthsOrderTitle": MessageLookupByLibrary.simpleMessage("ترتيب الشهور"),
    ...
    "no_award": MessageLookupByLibrary.simpleMessage("لا توجد جائزة"),
    "no_learner_data_available": MessageLookupByLibrary.simpleMessage(
      "لا توجد بيانات متاحة للمتعلم.",
    ),
    "no_learning_activities": MessageLookupByLibrary.simpleMessage(
      "لم يتم تسجيل أي نشاط تعليمي لهذا اليوم",
    ),
    "no_progress_data": MessageLookupByLibrary.simpleMessage(
      "لا توجد بيانات متاحة",
    ),
    "objectDetected": MessageLookupByLibrary.simpleMessage(
      "رائع! تم اكتشاف الشيء!",
    ),
    "objectDetectionExercise": MessageLookupByLibrary.simpleMessage(
      "تمرين كشف الأشياء",
    ),
    "objectDetectionHint": MessageLookupByLibrary.simpleMessage(
      "وجه الكاميرا نحو الشيء المطلوب لإكمال التمرين",
    ),
    ...
    "orContinueWith": MessageLookupByLibrary.simpleMessage("أو اكمل بواسطة"),
    "orderAscending": MessageLookupByLibrary.simpleMessage(
      "من البداية إلى النهاية",
    ),
    "orderDescending": MessageLookupByLibrary.simpleMessage(
      "من النهاية إلى البداية",
    ),
    "orderMonthsCorrectly": MessageLookupByLibrary.simpleMessage(
      "رتب الأشهر بشكل صحيح.",
    ),
    ...
    "parentNavBarChangeLanguage": MessageLookupByLibrary.simpleMessage(
      "اختر اللغة",
    ),
    "parentNavBarChooseLanguage": MessageLookupByLibrary.simpleMessage(
      "اختر اللغة",
    ),
    "parentNavBarEnglish": MessageLookupByLibrary.simpleMessage("الإنجليزية"),
    "parentNavBarFooterVersion": MessageLookupByLibrary.simpleMessage(
      "تطبيق التعلم الإصدار 2.0",
    ),
    "parentNavBarHome": MessageLookupByLibrary.simpleMessage("القائمة"),
    "parentNavBarLearnerMembers": MessageLookupByLibrary.simpleMessage(
      "أعضاء المتعلمين",
    ),
    "parentNavBarLearnersProgress": MessageLookupByLibrary.simpleMessage(
      "تقدم المتعلمين",
    ),
    "parentNavBarLogout": MessageLookupByLibrary.simpleMessage("تسجيل الخروج"),
    "parentNavBarLogoutConfirmation": MessageLookupByLibrary.simpleMessage(
      "تأكيد تسجيل الخروج",
    ),
    "parentNavBarLogoutPrompt": MessageLookupByLibrary.simpleMessage(
      "هل أنت متأكد أنك تريد تسجيل الخروج؟",
    ),
    "parentNavBarProfile": MessageLookupByLibrary.simpleMessage("حساب تعريفي"),
    "parentNavBarSettings": MessageLookupByLibrary.simpleMessage("الاعدادات"),
    ...
    "progressPoints": m19,
    "progressWillBeLost": MessageLookupByLibrary.simpleMessage(
      "سيتم فقدان تقدمك",
    ),
    "progress_summary": MessageLookupByLibrary.simpleMessage("ملخص التقدم"),
    "quest_complete": MessageLookupByLibrary.simpleMessage("المهمة مكتملة"),
    "quest_pending": MessageLookupByLibrary.simpleMessage(
      "المهمة قيد الانتظار",
    ),
    ...
    "score": m24,
    "searchCoursesHint": MessageLookupByLibrary.simpleMessage(
      "ابحث عن الدورات...",
    ),
    "search_hint": MessageLookupByLibrary.simpleMessage("ابحث عن الأنشطة..."),
    "seconds": m25,
    "secondsRemaining": m26,
    "seeAll": MessageLookupByLibrary.simpleMessage("عرض الكل"),
    "selectGameToPlay": MessageLookupByLibrary.simpleMessage("اختر لعبة للبدء"),
    "selectLevelToStart": MessageLookupByLibrary.simpleMessage(
      "اختر مستوى للبدء باللعب",
    ),
    "showMore": MessageLookupByLibrary.simpleMessage("عرض المزيد"),
    "signup_password_mismatch": MessageLookupByLibrary.simpleMessage(
      "ليس  متماشث",
    ),
    "signupbutton": MessageLookupByLibrary.simpleMessage("استمرار"),
    "signupinputfieldbirthdate": MessageLookupByLibrary.simpleMessage(
      "مثال:15/7/2002",
    ),
    "signupinputfieldemail": MessageLookupByLibrary.simpleMessage(
      "مثال:ibrahimzekas@gmail.com",
    ),
    "signupinputfieldname": MessageLookupByLibrary.simpleMessage(
      "مثال:ابراهيم مصطفي",
    ),
    "signupinputfieldnationality": MessageLookupByLibrary.simpleMessage(
      "مثال:مصري",
    ),
    "signupinputfieldpassword": MessageLookupByLibrary.simpleMessage(
      "مثال:MyP@ssw0rd123",
    ),
    "signupinputfieldusername": MessageLookupByLibrary.simpleMessage(
      "مثال:ibrahimzekas123",
    ),
    "signuptitlebirthdate": MessageLookupByLibrary.simpleMessage(
      "تاريخ الميلاد",
    ),
    "signuptitleconfirmpassword": MessageLookupByLibrary.simpleMessage(
      "تأكيد كلمة المرور",
    ),
    "signuptitleemail": MessageLookupByLibrary.simpleMessage(
      "البريد الالكتروني",
    ),
    "signuptitlename": MessageLookupByLibrary.simpleMessage("الاسم"),
    "signuptitlenationality": MessageLookupByLibrary.simpleMessage("الجنسية"),
    "signuptitlepassword": MessageLookupByLibrary.simpleMessage("كلمة المرور"),
    "signuptitlephonenumber": MessageLookupByLibrary.simpleMessage(
      "رقم الهاتف",
    ),
    "signuptitleusername": MessageLookupByLibrary.simpleMessage("اسم المستخدم"),
    ...
    "storyCounter": m28,
    "storySummarizerGame": MessageLookupByLibrary.simpleMessage(
      "لعبة تلخيص القصص",
    ),
    "strokeCount": m29,
    ...
    "summaryHint": MessageLookupByLibrary.simpleMessage(
      "اكتب ملخصاً للقصة التي قرأتها...",
    ),
    ...
    "tips_title": MessageLookupByLibrary.simpleMessage("نصائح"),
    ...
    "total_attempts": MessageLookupByLibrary.simpleMessage("إجمالي المحاولات"),
    "traceThisLetter": m30,
    "traceTitle": MessageLookupByLibrary.simpleMessage("✍️ تتبع الحرف"),
    "track_learning_progress": MessageLookupByLibrary.simpleMessage(
      "تتبع تقدم التعلم",
    ),
    ...
    "translateMonthsTooltip": MessageLookupByLibrary.simpleMessage(
      "تبديل أسماء الشهور",
    ),
    "tryAgain": MessageLookupByLibrary.simpleMessage("حاول مرة أخرى"),
    "tryAgain2": m31,
    "tryAgain3": MessageLookupByLibrary.simpleMessage("❌ حاول مرة أخرى"),
    "tryAgainEncouragement": MessageLookupByLibrary.simpleMessage(
      "حاول مرة أخرى! 💪",
    ),
    ...
    "tryingHardGreat": MessageLookupByLibrary.simpleMessage(
      "أنت تحاول بجد، هذا رائع",
    ),
    "tryingIsFirstStep": MessageLookupByLibrary.simpleMessage(
      "المحاولة هي الخطوة الأولى",
    ),
    ...
    "tutorialCourseCardTitle": MessageLookupByLibrary.simpleMessage(
      "هذه هي دورتك",
    ),
    ...
    "tutorialExpandButtonTitle": MessageLookupByLibrary.simpleMessage(
      "عرض المزيد",
    ),
    "tutorialPlayButtonDescription": MessageLookupByLibrary.simpleMessage(
      "اضغط على هذا الزر لبدء التمرين.",
    ),
    "tutorialPlayButtonTitle": MessageLookupByLibrary.simpleMessage(
      "زر التشغيل",
    ),
    ...
    "welcome_message": MessageLookupByLibrary.simpleMessage("مرحبًا بعودتك، "),
    "wellDone": MessageLookupByLibrary.simpleMessage(" !أحسنت ✅"),
    "whatIsDirection": MessageLookupByLibrary.simpleMessage("ما هو الاتجاه؟"),
    "wordsGame3Title": MessageLookupByLibrary.simpleMessage("لعبة الشهور"),
    "writeSummaryHere": MessageLookupByLibrary.simpleMessage("اكتب ملخصك هنا"),
    "wrongAnswer": m32,
